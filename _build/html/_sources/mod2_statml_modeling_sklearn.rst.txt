...
.. toctree::
   ...
   Review of sklearn and ensemble models <mod2a_sklearn_review>
   Using cookiecutters to structure projects <mod2b_pumpitup_project_structure> 
   Data prep for Pump it Up project <mod2c_pumpitup_dataprep> 
   Regularization and more classifier models <mod2d_pumpitup_modeling>
